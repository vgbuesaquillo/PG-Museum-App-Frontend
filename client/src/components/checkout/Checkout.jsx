...
const Checkout = () => {
    ...
    return (<div className="maincontainer">
        <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
            ...
            <button class="btn btn-outline-primary" href="#">Sign up</button>
        </div>
        <div class="container">
            ...
            <footer class="my-5 pt-5 text-muted text-center text-small">
                ...
                <ul class="list-inline">
                    {/* <li class="list-inline-item"><NavLink>Privacy </NavLink></li>
                    <li class="list-inline-item"><NavLink>Terms </NavLink></li>
                    <li class="list-inline-item"><NavLink>Support </NavLink></li> */}
                </ul>
            </footer>
        </div>
